  ...
  return (
    <div>
      ...
      <div className="content-body">
        ...
        as well as crucial social and life skills. Undergrad enhances people’s
        intellectual curiosity and drive to push the frontiers of knowledge or
        their employability in corporate America to achieve their dream job; it
        allows people to start their journey of self-discovery and newfound
        social life while balancing basic life chores. However, college is very
        expensive and once people leave college, many people have a hard to time
        to stay in touch with their college friends. Furthermore, as with the
        boom and bust economic cycle, it’s hard out there for many people,
        looking for jobs and looking to start their adult life in new cities or
        whatever.
        <br />
        <br />
          ...
          description={
            <div>
              ...
              <p className="text-gray-600">
                With a rich palette of interests ranging from film and creative
                writing to screenwriting, computer science, and community
                engagement, I am eager to bring my blend of creative insight and
                technical acumen to a team that values transformative ideas and
                is committed to making a difference through their work.
              </p>
            </div>
          }
        ...
        <Card
          ...
          description={
            <div>
              ...
              <p className="text-gray-600">
                With a passion for learning and exploring the natural world, I
                am pursuing a Bachelor of Science degree in Biology at Bucknell
                University. I am also interested in marketing and diversity, and
                I have developed relevant skills and knowledge through my work
        ...
        <Card
          ...
          description={
            <div>
              ...
              <p className="text-gray-600">
                Member of the class of 2025, majoring in International Relation,
                and Women and Gender Studies. Freeman scholar and SHE-CAN
                Scholar. Student Intern at Griot Institute for Black Life and
                culture. Student assistant for Alumina House, Bucknell
                University.
              </p>
            </div>
          }
        ...
        <Card
          ...
          description={
            <div>
              ...
              <p className="text-gray-600">
                With a desire to bring value into people's lives at low to no
                monetary costs, I was inspired by the founders' vision for Coop
                and wanted to apply my skillset to their mission. I am the sole
                developer for the Coop web app.
              </p>
            </div>
          }
          imageUrl={warren_img}
