...
import { INTERESTS_OPTIONS } from "@app/appConstants";

interface InterestsInputProps {
  values: string[];
  setValues: (newVals: string[]) => void;
        ...
        {INTERESTS_OPTIONS.map((interest) => (
          ...
          >
            <input
              ...
              checked={values.includes(interest)}
            />
